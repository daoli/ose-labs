...
boot_alloc(uint32_t n)
{
	...
	avail_npages = npages - ((uintptr_t) nextfree - KERNBASE) / PGSIZE;
	...
	if (nextfree < result) {
		// in this case, the last page at the end of 256MB is allocated,
		// nextfree overflows to 0.
...
page_init(void)
{
	...
	int npages_kern = ((uintptr_t) boot_alloc(0) - KERNBASE) / PGSIZE;
